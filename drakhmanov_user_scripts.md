...
7. Изначально линии, обозначающие Проходимость людей на улицах, показывают загруженность улиц с 8:00 до 22:00
8. Пользователь в полях ввода слева от карты может выбрать при каких значениях проходимости цвета линий должны отображаться Зелёным, Желтым или Красным цветами
...
4. Под кнопкой ВОЙТИ есть ссылка на регистрацию, при нажатии на которую пользователь переходит на страницу регистрации, и ссылка на страницу восстановления пароля. На данной странице пользователю необходимо будет указать электронную почту, привязанную к его учётной записи. После этого на указанную почту придёт пароль, сформированный из 15 рандомных символов.
...
3. Пользователь может поменять свой пароль, ФИО или email, если захотел. Чтобы сделать это пользователю необходимо нажать на кнопку ИЗМЕНИТЬ ИНФОРМАЦИЮ в своём личном кабинете. Тогда его перебросит на страницу изменения информации профиля. Для изменения также необходимо ввести код подтверждения, который придёт пользователю на указанный в профиле email.
4. Пользователю необходимо будет подтвердить свой email для полноценной работы с сайтом. Сделать это он может нажатием на предупреждение в личном кабинете.
