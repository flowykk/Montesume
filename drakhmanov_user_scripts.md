...
11. При нажатии на кнопку ОЧИСТИТЬ появляется окно c несколькими способами очищение (подробнее в СЦЕНАРИИ 7)
...
17. При нажатии на кнопку ОЧИСТИТЬ появляется окно c несколькими способами очищение (подробнее в СЦЕНАРИИ 7)
...
7. Пользователь не сможет нажать на кнопкиОВАТЬСЯ, если ввёл невалидную информацию (Например,если пользователь ввёл email без символа @ или ввёл иноформацию только в одно из двух полей для ввода)
