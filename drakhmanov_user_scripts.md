...
5. При нажатии на "логотип" проекта произойдёт перемещение на главную страницу
6. Внизу каждой страницы проекта содержится следующая информация: контактная информация для связи, описание способов работы с проектом, а также информация о проекте

**[ Сценарий 2 - Работа с картой ]**
1. Передвижение по карте осуществляется при помощи зажатия ЛКМ (Левой Кнопки Мыши) и движением самой мыши в соответствующую сторону просмотра
...
1. Стандартные действия для способов II-IV описаны в Доп.Сценарии
...
5. Под полями ввода есть ползунок, позволяющий менять плотность заливки округов
...
1. Стандартные действия для способов II-IV описаны в Доп.Сценарии
2. При нажатии на кнопку ОЧИСТИТЬ появляется окно c несколькими способами очищения карты (подробнее в СЦЕНАРИИ 7)
3. Для двух районов на карте (Савёловский, Южное Медведково (информацию о других районах можно получить только платно) доступна Тепловая Карта с плотностью населения в этих районах 
...
6. Под полями ввода находится список с возможностью выбора за какой промежуток времени отображать проходимость
7. Можно выбрать проходимость людей за месяц/день/ежечасно с 8,00 до 20,00/ежечасно с 8,00 до 10,00/ежечасно с 17,00 до 19,00/ежечасно с 22,00 до 8,00
...
1. На каждой странице сайта есть кнопка ВХОД (если пользователь ещё не вошёл в аккаунт)
...
2. На странице личного кабинета пользователь может посмотреть ФИО и email, которые он указывал при входе на сайт
3. Для полноценной работы с сайтом пользователю необходимо будет подтвердить свой email
4. На странице пользователя также доступна таблица с историей его запросов
5. При желании пользователь может очистить историю своих запросов
